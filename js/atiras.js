$(document).ready(function(){
	...
	$('#hatosagi_dijak').change(function(){
		...
		if($('#hatosagi_dijak option:selected').text() == 'Személygépjárművek')
		{
			$('#motorkerekparok').hide();
			$('#kisteherautok').hide();
			$('#tehergepkocsi').hide();
		...
		if($('#hatosagi_dijak option:selected').text() == 'Motorkerékpárok')
		{
			$('#szemelygepjarmuvek').hide();
			$('#kisteherautok').hide();
			$('#tehergepkocsi').hide();
		...
		if($('#hatosagi_dijak option:selected').text() == 'Kisteherautók (3,5t össztömegig)')
		{
			$('#szemelygepjarmuvek').hide();
			$('#motorkerekparok').hide();
			$('#tehergepkocsi').hide();
		...
		if($('#hatosagi_dijak option:selected').text() == 'Autóbuszok')
		{
			$('#szemelygepjarmuvek').hide();
			$('#motorkerekparok').hide();
			$('#kisteherautok').hide();
